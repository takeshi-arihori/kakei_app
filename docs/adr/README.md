...
| [Retention削除とGroup Management Receiptの順序](retention-deletion-receipt-order.md) | Accepted / Active | [Owner Decision #115](https://github.com/takeshi-arihori/kakei_app/issues/115)、Amends #55／#102、[Accepted sync PR #117](https://github.com/takeshi-arihori/kakei_app/pull/117) |
