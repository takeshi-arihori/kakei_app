...
| [Group終了の整合性と保持期限境界](group-close-consistency-and-retention-boundary.md) | Accepted（正式Review pass、Repository同期PR待ち） | [ADR #73](https://github.com/takeshi-arihori/kakei_app/issues/73)、[Owner承認](https://github.com/takeshi-arihori/kakei_app/issues/73#issuecomment-5755615829)、[正式Review](https://github.com/takeshi-arihori/kakei_app/issues/73#issuecomment-5755728805) |
...
- [Group終了の整合性と保持期限境界](group-close-consistency-and-retention-boundary.md): Accepted。Close Intent、Context所有fence／Receipt、Closing認可、2月29日clampを採用。Repository同期と正式Security Reviewの完了後に#75をReady評価する。
