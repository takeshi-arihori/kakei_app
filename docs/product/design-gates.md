...
- Invitation lifecycleと再参加Participant寿命はADR #52でAcceptedとなった。Persistence、本番本人性・認証・配送、Invitation／冪等記録の保存保護、Context間認可、Retention、Backup、Projectionの詳細は必要な後続Decisionを経て確定する。
